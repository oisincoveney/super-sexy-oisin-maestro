...
- [ ] **Task 8:** `src/main/tunnel-manager.ts`
...
- [ ] **Task 9:** `src/main/history-manager.ts`
...
- [ ] **Task 10:** `src/main/auto-updater.ts` and `src/main/update-checker.ts`
...
- [ ] **Task 13:** `src/main/ipc/handlers/agentSessions.ts`
