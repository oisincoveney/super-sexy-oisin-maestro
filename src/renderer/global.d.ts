...
interface MaestroAPI {
  ...
  fs: {
    ...
    rename: (oldPath: string, newPath: string, sshRemoteId?: string) => Promise<{ success: boolean }>;
    delete: (targetPath: string, options?: { recursive?: boolean; sshRemoteId?: string }) => Promise<{ success: boolean }>;
    countItems: (dirPath: string, sshRemoteId?: string) => Promise<{ fileCount: number; folderCount: number }>;
  };
  webserver: {
