...
import { ExternalLinkNode, type ExternalLinkNodeProps } from '../../../../renderer/components/DocumentGraph/ExternalLinkNode';
...
function createNodeProps(overrides: Partial<ExternalLinkNodeProps['data']> = {}): ExternalLinkNodeProps {
  return {
    id: 'test-external-1',
...
describe('ExternalLinkNode', () => {
  ...
  describe('URL Tooltip', () => {
    ...
    it('shows all URLs in tooltip when multiple URLs', () => {
      ...
      const node = container.querySelector('.external-link-node');
      const expectedTooltip = 'https://example.com/page1\nhttps://example.com/page2\nhttps://example.com/page3';
